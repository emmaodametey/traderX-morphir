...
-}
module TraderX.TradeService.Order exposing (..)


-- import TraderX.TradeService.Shared.Price exposing (..)
-- import TraderX.TradeService.Shared.Product as Product
-- import TraderX.TradeService.Shared.Quantity exposing (..)
...
-}
type BuyResponse
    = BuyAccepted ID Product Price Quantity
